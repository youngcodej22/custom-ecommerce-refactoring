...
export const products = [
    {
        category: 'NEW',
        name: '니트 하이브리드 다운 블랙 MCM4JD636 BLK',
        image: product_new_1,
        price: '890,000',
        labels: [
            {
    ...
    }, // ... Add 7 more product objects
    {
        category: 'MEN',
        name: '아노락 패딩 베스트 MCM3JV823 IVY',
        image: product_new_2,
        price: '510,000',
        labels: [
            {
    ...
    {
        category: 'MEN',
        name: '빅로고 반집업 방풍 스웨터 아이보리 MCM4ST756 IVY',
        image: product_new_3,
        price: '650,000',
        labels: [
            {
    ...
    {
        category: 'NEW',
        name: '스코티시 반집업 스웨터 MCM4ST638 LBL',
        image: product_new_4,
        price: '650,000',
        labels: [
            {
    ...
    {
        category: 'MEN',
        name: '소프트터치 하이넥 다운 카멜 MCM4JD837 CAM',
        image: product_new_5,
        price: '850,000',
        labels: [
            {
    ...
    {
        category: 'MEN',
        name: '아가일 앙고라 퍼 포인트 스웨터 MCM4ST755 MIN',
        image: product_new_6,
        price: '650,000',
        labels: [
            {
    ...
    {
        category: 'NEW',
        name: '빅로고 하이넥 기모 티셔츠 MCM4TB811 BLK',
        image: product_new_7,
        price: '290,000',
        labels: [
            {
    ...
    {
        category: 'MEN',
        name: '소프트터치 하이넥 다운 블랙 MCM4JD837 BLK',
        image: product_new_8,
        price: '850,000',
        labels: [
            {
